...
import com.example.baocaogiuaky.Trinhchieu.TrinhchieuConboFragment;
import com.example.baocaogiuaky.Trinhchieu.TrinhchieuConhoFragment;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link TrinhchieuConchoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TrinhchieuConchoFragment extends Fragment {
    ...
    public TrinhchieuConchoFragment() {
     ...
     * @return A new instance of fragment TrinhchieuConchoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TrinhchieuConchoFragment newInstance(String param1, String param2) {
        TrinhchieuConchoFragment fragment = new TrinhchieuConchoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_trinhchieu_concho, container, false);
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivity activity = (MainActivity) getActivity();
                if (activity != null) {
                    activity.replaceFragment(new TrinhchieuConboFragment());
                }
            }
        });
