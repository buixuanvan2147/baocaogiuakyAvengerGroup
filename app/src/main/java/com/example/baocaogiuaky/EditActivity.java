        ...
        buttonEditPronunciation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isEditingPronunciation) {
                    inputPronunciation.setEnabled(false);
                    buttonEditPronunciation.setBackground(ContextCompat.getDrawable(EditActivity.this, R.drawable.icon_edit));
                } else {
                    inputPronunciation.setEnabled(true);
                    buttonEditPronunciation.setBackground(ContextCompat.getDrawable(EditActivity.this, R.drawable.icon_cancel));
                }
